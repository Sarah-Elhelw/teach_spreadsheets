...
== Ods Write classes :
image::Images\Class_OdsWrite_diag.JPG[width="300", height="150"]
...
== Json Read classes:
image::Images\Class_Json_Read.JPG[width="400", height="300"]

The main goal of these classes is to read teachers and courses informations presented in a Json format. These informations are found in RefRof and in files in the class path. 
