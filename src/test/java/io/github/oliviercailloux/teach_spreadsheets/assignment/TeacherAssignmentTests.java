...
/**
 * This test class checks that the Builder and the setter setTeacher() prevent from building
 * incoherent teachers'assignments by throwing exceptions.
 * 
 * To handle the throwing of exceptions in unit testing, we took inspiration from the code in 
