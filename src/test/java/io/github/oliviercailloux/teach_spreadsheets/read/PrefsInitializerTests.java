	...
	void testCreatePrefsList() throws Exception {
		...
		try (InputStream stream = resourceUrl.openStream()) {
			try (SpreadsheetDocument document = SpreadsheetDocument.loadDocument(stream)) {
				 ...
				 */
				String expectedP12 = "CoursePref{prefCM=UNSPECIFIED, prefTD=UNSPECIFIED, prefCMTD=UNSPECIFIED, prefTP=UNSPECIFIED, prefCMTP=UNSPECIFIED, prefNbGroupsCM=0, prefNbGroupsTD=0, prefNbGroupsCMTD=0, prefNbGroupsTP=0, prefNbGroupsCMTP=0, Course=Course{name=Anglais 2, countGroupsTD=0, countGroupsCMTD=12, countGroupsTP=0, countGroupsCMTP=0, countGroupsCM=1, nbMinutesTD=0, nbMinutesCMTD=1170, nbMinutesTP=0, nbMinutesCMTP=0, nbMinutesCM=0, studyLevel=DE1, studyYear=2016/2017, semester=2}, Teacher=Teacher{lastName=Doe, firstName=, address=, postCode=, city=, personalPhone=, mobilePhone=, personalEmail=, dauphineEmail=, status=, dauphinePhoneNumber=, office=}}";
				 ...
				 * DE1.
				 */
				String expectedB4 = "CoursePref{prefCM=UNSPECIFIED, prefTD=UNSPECIFIED, prefCMTD=UNSPECIFIED, prefTP=UNSPECIFIED, prefCMTP=UNSPECIFIED, prefNbGroupsCM=0, prefNbGroupsTD=0, prefNbGroupsCMTD=0, prefNbGroupsTP=0, prefNbGroupsCMTP=0, Course=Course{name=TestCoursDE2S1, countGroupsTD=0, countGroupsCMTD=1, countGroupsTP=0, countGroupsCMTP=0, countGroupsCM=1, nbMinutesTD=0, nbMinutesCMTD=60, nbMinutesTP=0, nbMinutesCMTP=0, nbMinutesCM=60, studyLevel=DE2, studyYear=2016/2017, semester=1}, Teacher=Teacher{lastName=Doe, firstName=, address=, postCode=, city=, personalPhone=, mobilePhone=, personalEmail=, dauphineEmail=, status=, dauphinePhoneNumber=, office=}}";
