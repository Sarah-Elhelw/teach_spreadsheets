	...
	public void initPreferences(Set<CoursePrefElement> allPreferences) {
		...
		for (CoursePrefElement coursePrefElement : allPreferences) {
			...
			if (!coursesShown.contains(course)) {
				...
				tableItem.setText(new String[] {course.getName(), CourseType.CM.name(), String.valueOf(course.getCountGroupsCM())});
				tableItem = new TableItem(coursesTable, SWT.NONE);
				tableItem.setText(new String[] {course.getName(), CourseType.TD.name(), String.valueOf(course.getCountGroupsTD())});
				tableItem = new TableItem(coursesTable, SWT.NONE);
				tableItem.setText(new String[] {course.getName(), CourseType.TP.name(), String.valueOf(course.getCountGroupsTP())});
				tableItem = new TableItem(coursesTable, SWT.NONE);
				tableItem.setText(new String[] {course.getName(), CourseType.CMTP.name(), String.valueOf(course.getCountGroupsCMTP())});
				tableItem = new TableItem(coursesTable, SWT.NONE);
				tableItem.setText(new String[] {course.getName(), CourseType.CMTD.name(), String.valueOf(course.getCountGroupsCMTD())});
			}
