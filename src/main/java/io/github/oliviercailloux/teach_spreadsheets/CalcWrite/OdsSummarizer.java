...
public class OdsSummarizer {
	...
	private static SpreadsheetDocument createAnEmptyOds() throws Exception {
	...
	public static SpreadsheetDocument createSummarizedOds(ImmutableSet<Course> allCourses,
