...
public class TeachersPreferences {
	...
	*/
	...
	public static SpreadsheetDocument createTeachersPreferences(ImmutableSet<Course> allCourses,
		...
		document.save("target//TeachersPreferences.ods");
		return document;
	...
	public static SpreadsheetDocument addNewTeacher(SpreadsheetDocument document, Teacher teacher, ImmutableSet<Course> allCourses,
			ImmutableSet<CoursePref> prefs) throws Throwable {
