...
*** For the class diagrams :
**** Adding (when it's necessary) the types of return to Class_assignment and updating the image in the README
**** Adding (when it's necessary) the types of return to Class_ODS_Read and updating the image in the README
